"""The first run: a label-only readout at a fixed gain of 4, kept as the record of v1.

v1 treated every answer as one of several unrelated labels, which cannot decode a count.
run.py at the top level is the current version.

    python scripts/run_v1.py                 # every problem
    python scripts/run_v1.py --only 20 191   # a subset

Writes results/v1/results.json and results/v1/readouts.npz.
"""
import argparse
import json
import sys
...
from flybrain.brain import BrainConfig, FlyBrain, Readout, fit_readout  # noqa: E402
from flybrain.dataset import RESULTS, make_data  # noqa: E402
from flybrain.problems import PROBLEMS, bag_of_tokens, label_of  # noqa: E402
